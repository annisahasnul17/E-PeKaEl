								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="form-group">
											...
											<textarea name="alamat" class="form-control" style="resize: none;" rows="6" placeholder="Masukkan alamat, kabupaten, kecamatan & Kode POS Anda"></textarea>
										</div>
											...
											// cek apakah produk sudah ada dalam keranjang
												...
												for($a = 0; $a < $jumlah_isi_keranjang; $a++){
													...
													<tr>
														...
														<td class="text-center">
															<?php echo "Rp. ".number_format($i['produk_berat']) . " ,-"; ?>
														</td>
