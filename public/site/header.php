...
<head>
	...
	<title>E-Pekael Solusi PKL</title>

	<!-- Google font -->
	<link href="https://fonts.googleapis.com/css?family=Hind:400,700" rel="stylesheet">
	
	<link rel="shortcut icon" href="gambar/sistem/shop-icon.png">
	...
	<header>
		...
		<div id="header">
			<div class="container">
				<div class="pull-left">
					<!-- Logo -->
					<div class="header-logo">E-;pekael</div>
					<!-- /Logo -->
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="category-nav show-on-click">
					<span class="category-header">Kategori Produk <i class="fa fa-angle-down"></i></span>
