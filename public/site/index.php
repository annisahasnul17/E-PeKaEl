							...
							<div class="col-md-3 col-sm-6 col-xs-6">
								<div class="product product-single">
									...
									<div class="product-body">
										<h3 class="product-price"><?php echo "Rp. ".number_format($d['produk_harga']).",-"; ?> <?php if($d['produk_jumlah'] == 0){?> <del class="product-old-price">Kosong</del> <?php } ?>
									</h3>
										...
										<div class="product-btns">
											...
											<a class="main-btn btn-block text-center" href="https://api.whatsapp.com/send?phone=6281262110476&text=Saya%20tertarik%20untuk%20membeli%20produk%20di%20toko%20anda"><i class="fa fa-whatsapp"></i> Order melalui WA</a>
