      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <img src="http://localhost/pekaels/resources/img/logoo.png" width="60%" style="border-radius: 50%" />
            <h4 class="card-title" style="padding-top: 20px"><strong>{{ __('Daftar Akun') }}</strong></h4>
          </div>
          <div class="card-body ">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
		  	...
		  	<h4 class="card-title" style="text-align: center;">{{ __('Daftar Sebagai') }}</h4>
